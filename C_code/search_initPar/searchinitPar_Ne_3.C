...
void FitHL(TH1D *hist1, int rebin=1, int binnum=-1, double chi2_min=2){
  ...
  TF1 *f2 = new TF1("f2",Draw_fit,0,binnum*rebin/10,5);  // 30Ne
  ...
  f3->SetParameter(1,p.first[7]);                        // constant bg
  ...
  f4->SetParameter(1,p.first[7]);                        // constant bg
  ...
  f5->SetParameter(1,p.first[7]);                        // constant bg
